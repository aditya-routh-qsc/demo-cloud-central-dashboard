## Purpose
Define the functional and UX requirements for the central dashboard frontend interface, including shared filtering behavior, operational trust visibility, ticket navigation, mobile summary behavior, and backend contract alignment.
